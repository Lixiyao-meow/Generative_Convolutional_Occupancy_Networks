...
class Generator3D(object):
    ...
    def generate_mesh(self, data, start_epoch, epoch, return_stats=True):
        ...
        mesh = self.generate_from_latent(start_epoch, epoch, c, stats_dict=stats_dict, **kwargs)
    ...
    def generate_from_latent(self, start_epoch, epoch, c=None, stats_dict={}, **kwargs):
        ...
        if self.upsampling_steps == 0:
            ...
            values = self.eval_points(start_epoch, epoch, pointsf, c, **kwargs).cpu().numpy()
    ...
    def eval_points(self, start_epoch, epoch, p, c=None, vol_bound=None, **kwargs):
        ...
        for pi in p_split:
            if self.input_type == 'pointcloud_crop':
                ...
                with torch.no_grad():
                    occ_hat = self.model.decoder(pi, c, start_epoch, epoch, **kwargs).logits
                occ_hats.append(occ_hat.squeeze(0).detach().cpu())
